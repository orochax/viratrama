...
export const transmissions: AudioTransmission[] = [
  ...
  { code: "MEDIA-OMN-VEGA-ALERTA", characterSlug: "vega", characterName: "Vega", role: "Coordenadora operacional", kind: "alert", title: "Doze minutos", transcript: "O alarme foi confirmado. A polícia chega em doze minutos. A partir de agora, o relógio não para. Encontrem a chave, decidam o destino do Atlas e saiam juntos.", audioPath: audio("vega", "MEDIA-OMN-VEGA-ALERTA"), portraitPath: "media/characters/vega.png", theme: "vega", requiresCompletion: true, completionRule: "host_or_transcript", status: "not_recorded" },
];
